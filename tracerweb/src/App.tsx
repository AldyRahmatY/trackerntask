...
import { Home, Calendar, BarChart2, Settings, Moon, Sun } from "lucide-react";
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: "/settings", icon: <Settings size={24}/>, label: "Atur" },
  ];
...
function App() {
  return (
    // Bungkus paling luar dengan ThemeProvider
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      <TrackerProvider>
        <BrowserRouter>
          <div className="min-h-screen bg-gray-50/50 bg-stone-100 dark:bg-zinc-900 font-Satoshi text-foreground md:pl-24 transition-colors duration-300">
            <main className="max-w-md mx-auto min-h-screen bg-background shadow-2xl md:shadow-none overflow-hidden relative border-x border-border/40">
              <div className="h-full overflow-y-auto p-6 pb-32 md:p-10">
                <Routes>
